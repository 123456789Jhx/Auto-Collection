function createDouyinAdapter(config, logger, ocrEngine, floatyControl, injectedScreenRecognizer, injectedLiveTargetMatcher) {
  ...
  function getCommerceCardBrowser() {
    if (!commerceCardBrowser) {
      commerceCardBrowser = createDouyinCommerceCardBrowser({
        ...
        setActiveSearchKeyword: function (keyword) {
        ...
        pushFoundNodes: pushFoundNodes,
        getNodeOwnText: getNodeOwnText,
        collectNodeContextText: collectNodeContextText,
        isTargetSearchBoundsAllowed: isTargetSearchBoundsAllowed,
        isLiveEntryBoundsAllowed: isLiveEntryBoundsAllowed,
        openLiveRoomFromCurrentScreen: openLiveRoomFromCurrentScreen,
        isLiveRoomVisible: isLiveRoomVisible,
        exitLiveRoom: exitLiveRoom,
        swipeSearchResultsUp: swipeSearchResultsUp,
        back: function () {
          return back();
        }
      });
    }
    return commerceCardBrowser;
  }

  function openCommerceCardSearch(keyword) {
    return getCommerceCardBrowser().openCommerceCardSearch(keyword);
  }
  ...
  function openMatchingCommerceLiveFromCards(options) {
    return getCommerceCardBrowser().openMatchingCommerceLiveFromCards(options);
  }

  function browseCommerceCards(options) {
    return getCommerceCardBrowser().browseCommerceCards(options);
  }
