...
2. `docs/当前入口/overview.md` 提供项目目标、当前成果和文档入口。
3. `docs/当前入口/deployment.md` 提供生产部署和清理数据库说明。
4. `docs/方案设计/README.md` 提供当前架构方案、功能方案和后续方案索引。
5. `docs/项目记录/项目现状.md` 记录当前完成度和边界。
6. `docs/项目记录/卡点与Bug记录.md` 记录阶段卡点、bug 和剩余风险。
7. `docs/成果证据/README.md` 列出已有证据和待补证据。
